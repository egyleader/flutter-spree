...
class Prefs {
  ...
  static Future<bool> setColor(String key, Color color) async {
    ...
    return prefs?.setInt(key, color.value) ?? Future.value(false);
  }
  ...
  static Future<bool> setString(String key, String value) async {
    ...
    return prefs?.setString(key, value) ?? Future.value(false); // null aware 
  }

  static int getInt(String key, [int defValue]) {
    return _prefsInstance.getInt(key) ?? defValue ?? 0; // null aware 
  }
